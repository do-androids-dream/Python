...
#     result = []
#     for i in scripture:
#         result.append(i) if i[:-2].find(book + chapter) != -1 else 0
#     return result

def filterBible(scripture, book, chapter):
    result = [i for i in scripture if i[:-2].find(book + chapter) != -1]
    return result

print(filterBible(["01001001", "01001002", "01002001", "01002002", "01002003", "02001001", "02001002", "02001003"], "01", "001"))